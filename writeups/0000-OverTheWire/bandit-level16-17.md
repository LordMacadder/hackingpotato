...
##Solution
1. SSH onto the server with the username bandit16

2. Scan ports 31000 to 32000 using nmap
...
3. nc each one until one gives you an ssl error message
...
4. This gives us 31518 and 31790 as possible ports, so now use the same commands as last level
